...
var Configuration={torrentRefreshInterval:1250,sessionRefreshInterval:1e4,torrentsPerPage:20,torrentView:"grid",language:"en"},Configurator={set:function(){Configuration.torrentRefreshInterval=session.isEmpty("torrentRefreshInterval")?Configuration.torrentRefreshInterval:session.get("torrentRefreshInterval"),Configuration.sessionRefreshInterval=session.isEmpty("sessionRefreshInterval")?Configuration.sessionRefreshInterval:session.get("sessionRefreshInterval"),Configuration.torrentsPerPage=session.isEmpty("torrentsPerPage")?Configuration.torrentsPerPage:session.get("torrentsPerPage"),Configuration.torrentView=session.isEmpty("torrentView")?Configuration.torrentView:session.get("torrentView"),Configuration.language=session.isEmpty("language")?Configuration.language:session.get("language")}};
var Formatter={units:"",speed_K:1e3,size_K:1e3,mem_K:1024,duration:function(e){return new Date(1e3*e).toTimeString().replace(/.*(\d{2}:\d{2}:\d{2}).*/,"$1")},date:function(e){return new Date(1e3*e)},filePriority:function(e){return e==-1?i18n.units.low:0===e?i18n.units.normal:1==e?i18n.units.high:void 0},percentageDone:function(e,t){return Math.round((t-e)/t*1e4)/100+"%"},mem:function(e){if(e<Formatter.mem_K)return[e,i18n.units.mem_B_str].join(" ");var t,n;return e<Math.pow(Formatter.mem_K,2)?(t=e/Formatter.mem_K,n=i18n.units.mem_K_str):e<Math.pow(Formatter.mem_K,3)?(t=e/Math.pow(Formatter.mem_K,2),n=i18n.units.mem_M_str):e<Math.pow(mem_K,4)?(t=e/Math.pow(Formatter.mem_K,3),n=i18n.units.mem_G_str):(t=e/Math.pow(Formatter.mem_K,4),n=i18n.units.mem_T_str),t=Math.round(100*t)/100,[t,n].join("")},ratio:function(e,t){return 0===e?0:Math.floor(t/e*1e3)/1e3},size:function(e){if(e<Formatter.size_K)return[e,i18n.units.size_B_str].join("");var t,n;return e<Math.pow(Formatter.size_K,2)?(t=e/Formatter.size_K,n=i18n.units.size_K_str):e<Math.pow(Formatter.size_K,3)?(t=e/Math.pow(Formatter.size_K,2),n=i18n.units.size_M_str):e<Math.pow(Formatter.size_K,4)?(t=e/Math.pow(Formatter.size_K,3),n=i18n.units.size_G_str):(t=e/Math.pow(Formatter.size_K,4),n=i18n.units.size_T_str),t=Math.round(100*t)/100,[t,n].join("")},speed:function(e){if(e<Formatter.speed_K)return[e,i18n.units.speed_B_str].join("");var t,n;return e<Math.pow(Formatter.speed_K,2)?(t=e/Formatter.speed_K,n=i18n.units.speed_K_str):e<Math.pow(Formatter.speed_K,3)?(t=e/Math.pow(Formatter.speed_K,2),n=i18n.units.speed_M_str):e<Math.pow(speed_K,4)?(t=e/Math.pow(Formatter.speed_K,3),n=i18n.units.speed_G_str):(t=e/Math.pow(Formatter.speed_K,4),n=i18n.units.speed_T_str),t=Math.round(100*t)/100,[t,n].join("")},event:function(e){switch(e){case 0:return i18n.event.paused;case 1:return i18n.event.queuedForVerification;case 2:return i18n.event.verifyingLocalData;case 3:return i18n.event.queued;case 4:return i18n.event.downloading;case 5:return i18n.event.downloadedQueuedForSeeding;case 6:return i18n.event.seeding;case 8:return i18n.event.seeding;default:return i18n.event.unknown}}};
var activeTab="all",session=Storages.initNamespaceStorage("layeredWebUI").localStorage,TopBar={statistics:function(){$("section.topBar p.additionalData span.statistics").unbind(),$("section.topBar p.additionalData span.statistics").click(function(){Sidebar.open("statistics"),$("section.sidebarOverflow").click(function(){clearInterval(Listener.sessionStatsInterval),$("section.sidebarOverflow").unbind()})})},filterBar:function(){$("section.header ul li").click(function(){var e=!0;$('section.header ul li[data-href="'+activeTab+'"]').removeClass("active"),$(this).addClass("active"),$("section.torrents").removeClass("all downloading seeding idling queued paused errored"),$("section.torrents").addClass($(this).data("href")),$("section.torrents section.torrent").removeClass("suffix-2 tablet-suffix-5 prefix-2 tablet-prefix-5"),activeTab=$(this).data("href"),"all"!=activeTab?($("section.torrents").addClass("searchQuery"),$("section.torrents section.torrent").each(function(t,i){$(this).hasClass(activeTab)?($(this).removeClass("suffix-2 tablet-suffix-5 prefix-2 tablet-prefix-5").addClass("result "+(e?"suffix-2 tablet-suffix-5":"prefix-2 tablet-prefix-5")),e=!e):$(this).removeClass("suffix-2 tablet-suffix-5 prefix-2 tablet-prefix-5").removeClass("result")})):($("section.torrents").removeClass("searchQuery"),$("section.torrents section.torrent").removeClass("suffix-2 tablet-suffix-5 prefix-2 tablet-prefix-5").removeClass("result"))})}},FloatingButtonHelper={init:function(){$("section.floatingActions ul, section.floatingOptions ul").addClass("hidden"),$("section.fixed-action-btn.click-to-toggle > a").click(function(){var e=$(this).parent().find("ul");e.hasClass("hidden")?e.removeClass("hidden"):setTimeout(function(){e.addClass("hidden")},250)})}},Sidebar={open:function(e){$("body").css("overflow","hidden"),"torrentInformation"==e?$("section.sidebar").removeClass("box-shadow"):$("section.sidebar").addClass("box-shadow"),$("section.sidebar > section").removeClass("active"),$("section.sidebar > section."+e).addClass("active"),$("section.sidebar").animate({right:"0%"},300),$("section.sidebarOverflow").removeClass("hidden"),$("section.sidebarOverflow").unbind(),$("section.sidebarOverflow").click(function(){$("body").css("overflow","initial"),$("section.sidebar").animate({right:"-100%"},300),$("section.sidebarOverflow").addClass("hidden")})},close:function(){$("body").css("overflow","initial"),$("section.sidebar").animate({right:"-100%"},300),$("section.sidebarOverflow").addClass("hidden")}};$(window).on("load",function(){Configurator.set(),Internationalization.changeLanguage(Configuration.language,function(){$("section.torrents").attr("view",Configuration.torrentView),$("ul.tabs").tabs(),$(".tooltipped").tooltip(),TopBar.statistics(),TopBar.filterBar(),FloatingButtonHelper.init(),Listener.setIntervals(),Listener.addTorrent(),Listener.updateSettings(),Listener.searchTorrent(),Listener.searchTracker(),Listener.toggleSpeedLimitButton(),Listener.showCredits(),TransmissionServer.getSettings()},!0)});
var Listener={sessionStatsInterval:null,torrentGetInterval:null,lastRefresh:1e3,updateDate:function(){function e(){var e=new Date,t=new Array("Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"),n=t[e.getDay()],r=new Array("th","st","nd","rd","th","th","th","th","th","th"),o=d+(e.getDate()<10)?"0"+e.getDate()+r[e.getDate()]:e.getDate()+r[parseFloat((""+e.getDate()).substr((""+e.getDate()).length-1))],s=new Array("January","February","March","April","May","June","July","August","September","October","November","December"),i=s[e.getMonth()],a=e.getFullYear(),d=n+", "+o+" of "+i+" "+a;$("section.topBar p.additionalData span.timeNow").text(d)}e(),setInterval(function(){e()},1e4)},updateSettings:function(){function e(){TransmissionServer.sendServerRequest({method:"session-get"},function(e){TransmissionServer._waitLock=!0,$("section.sidebar section.settings table").html(""),e=e.arguments,$.each(e,function(e,r){n.indexOf(e)!=-1||(t.indexOf(e)!=-1?$("section.sidebar section.settings table").append("<tr><td>"+e+'</td><td><input disabled value="'+r+'"></td></tr>'):("boolean"==typeof r?($("section.sidebar section.settings table").append("<tr><td>"+e+'</td><td><div class="switch"><label>'+i18n.status.off+'<input type="checkbox" name="'+e+'"><span class="lever"></span>'+i18n.status.on+"</label></div></td></tr>"),$('section.sidebar section.settings table input[type="checkbox"][name="'+e+'"]').prop("checked",r),$('section.sidebar section.settings table input[type="checkbox"][name="'+e+'"]').val(r)):"download-dir"==e?$("section.sidebar section.settings table").append('<tr data-spec="download-dir"><td>'+e+'</td><td><input name="'+e+'" value="'+r+'"></td></tr>'):$("section.sidebar section.settings table").append("<tr><td>"+e+'</td><td><input name="'+e+'" value="'+r+'"></td></tr>'),"download-dir"==e&&TransmissionServer.sendServerRequest({method:"free-space",arguments:{path:r}},function(e){e=e.arguments,$('<tr><td>download-dir-free-space</td><td><input disabled value="'+Formatter.size(e["size-bytes"])+'"></td></tr>').insertAfter($('section.sidebar section.settings table tr[data-spec="download-dir"]'))})))}),$('section.sidebar section.settings table input[type="checkbox"]').unbind(),$('section.sidebar section.settings table input[type="checkbox"]').click(function(){$(this).val($(this).prop("checked"))}),Listener.updateSettingsButton(),TransmissionServer._waitLock=!1})}$("section.floatingOptions a.settings").unbind(),$("section.floatingOptions a.settings").click(function(){Sidebar.open("settings")});var t=["blocklist-size","config-dir","rpc-version","rpc-version-minimum","version"],n=["units","download-dir-free-space"];e()},updateSettingsButton:function(){$("section.sidebar section.settings a.updateSettingsButton").unbind(),$("section.sidebar section.settings a.updateSettingsButton").click(function(){var e={};$("section.sidebar section.settings table tr td input:not(disabled):not(:checkbox)").serializeArray().map(function(t){"boolean"==typeof t.value||"number"!=typeof parseInt(t.value)||isNaN(parseInt(t.value))?e[t.name]=t.value:e[t.name]=parseInt(t.value)}),$("section.sidebar section.settings table tr td input:checkbox").each(function(){e[this.name]=this.checked}),TransmissionServer.sendServerRequest({method:"session-set",arguments:e},function(e){Materialize.toast(i18n.status.success,500,"rounded")})})},updateStatistics:function(){TransmissionServer.sendServerRequest({method:"session-stats",arguments:["activeTorrentCount","downloadSpeed","pausedTorrentCount","torrentCount","uploadSpeed","current-stats"]},function(e){TransmissionServer._waitLock=!0,e=e.arguments,$("section.topBar p.additionalData span.bandwidth").text("| "+Formatter.speed(e.downloadSpeed)+" ⬇ "+Formatter.speed(e.uploadSpeed)+" ⬆"),$("section.sidebar section.statistics table tr td.activeTorrents").text(e.activeTorrentCount),$("section.sidebar section.statistics table tr td.pausedTorrents").text(e.pausedTorrentCount),$("section.sidebar section.statistics table tr td.totalDownloaded").text(Formatter.size(e["cumulative-stats"].downloadedBytes)+" ("+Formatter.size(e["current-stats"].downloadedBytes)+" "+i18n.misc.thisSession+")"),$("section.sidebar section.statistics table tr td.totalUploaded").text(Formatter.size(e["cumulative-stats"].uploadedBytes)+" ("+Formatter.size(e["current-stats"].uploadedBytes)+" "+i18n.misc.thisSession+")"),$("section.sidebar section.statistics table tr td.ratio").text(Formatter.ratio(e["cumulative-stats"].downloadedBytes,e["cumulative-stats"].uploadedBytes)+" ("+Formatter.ratio(e["current-stats"].downloadedBytes,e["current-stats"].uploadedBytes)+" "+i18n.misc.thisSession+")"),$("section.sidebar section.statistics table tr td.uptime").text(Formatter.duration(e["cumulative-stats"].secondsActive)+" ("+Formatter.duration(e["current-stats"].secondsActive)+" "+i18n.misc.thisSession+")"),TransmissionServer._waitLock=!1})},toggleSpeedLimitButton:function(){$("section.floatingOptions a.speedLimitMode").unbind(),$("section.floatingOptions a.speedLimitMode").click(function(){TransmissionServer.sendServerRequest({method:"session-set",arguments:{"alt-speed-enabled":!!$("a.speedLimitMode").hasClass("green")}},function(e){Materialize.toast(i18n.status.success,500,"rounded"),TransmissionServer.getSettings()})})},addTorrent:function(){$('section.floatingActions a[data-action="add"]').unbind(),$('section.floatingActions a[data-action="add"]').click(function(){function e(){""!==$("section.sidebar section.addTorrent input.torrentLink").val()&&(args={filename:$("section.sidebar section.addTorrent input.torrentLink").val(),paused:!$("section.sidebar section.addTorrent input#startAutomatically").prop("checked")},0!=$("section.sidebar section.addTorrent input.torrentDirectory").val().length&&(args["download-dir"]=$("section.sidebar section.addTorrent input.torrentDirectory").val()),TransmissionServer.sendServerRequest({method:"torrent-add",arguments:args},function(e){"success"!=e.result?Materialize.toast(i18n.status.errorAddingTorrent+e.result,2e3,"rounded"):Materialize.toast(i18n.status.torrentAdded,2e3,"rounded"),$("section.sidebar section.addTorrent input.torrentLink").val(""),$("section.sidebar section.addTorrent input.torrentFile").prop("files",[])}))}Sidebar.open("addTorrent"),$("section.sidebar section.addTorrent input#startAutomatically").prop("checked",!0),$("section.sidebar section.addTorrent a.addTorrent").unbind(),$("section.sidebar section.addTorrent a.addTorrent").click(function(){var t=$("section.sidebar section.addTorrent input.torrentFile")[0].files;e(),""!=$("section.sidebar section.addTorrent input.torrentFilePathDisplay")&&$.each(t,function(e,t){var n=t,r=new FileReader;r.onload=function(){t=r.result,t=t.indexOf("base64,")>-1&&t.substring(t.indexOf("base64,")+7),0!=t&&(args={metainfo:t,paused:!$("section.sidebar section.addTorrent input#startAutomatically").prop("checked")},0!=$("section.sidebar section.addTorrent input.torrentDirectory").val().length&&(args["download-dir"]=$("section.sidebar section.addTorrent input.torrentDirectory").val()),TransmissionServer.sendServerRequest({method:"torrent-add",arguments:args},function(e){"success"!=e.result?(console.log(t),Materialize.toast(i18n.status.errorAddingTorrent+e.result,2e3,"rounded")):Materialize.toast(i18n.status.torrentAdded,2e3,"rounded")}))},r.readAsDataURL(n)}),$("section.sidebar section.addTorrent input.torrentFilePathDisplay").val("")})})},batchOperations:function(){var e={Start:"torrent-start",Pause:"torrent-stop",Verify:"torrent-verify","Ask tracker for more peers":"torrent-reannounce",Remove:"torrent-remove",Close:"close"};$('section.floatingActions ul a:not([data-action="add"]').unbind(),$('section.floatingActions ul a:not([data-action="add"]').click(function(){var t=[],n=e[$(this).data("action")];t=1==$("section.torrents section.torrent.selected").length?$("section.torrents section.torrent.selected").data("id"):$("section.torrents section.torrent.selected").map(function(){return $(this).data("id")}).get(),"torrent-remove"!=n?TransmissionServer.sendServerRequest({method:n,arguments:{ids:t}},function(e){Materialize.toast(i18n.status.success,500,"rounded")}):Listener.removeTorrent(t)})},changeDownloadedFiles:function(){$('section.sidebar section#files span.download input[type="checkbox"]').unbind(),$('section.sidebar section#files span.download input[type="checkbox"]').click(function(){var e=$(this).data("torrentid"),t=$(this).data("fileid"),n=$(this).prop("checked");n?TransmissionServer.sendServerRequest({method:"torrent-set",arguments:{ids:e,"files-wanted":[t]}},function(e){Materialize.toast(i18n.status.success,500,"rounded")}):TransmissionServer.sendServerRequest({method:"torrent-set",arguments:{ids:e,"files-unwanted":[t]}},function(e){Materialize.toast(i18n.status.success,500,"rounded")})})},changeSettingsTorrent:function(e){$("section.sidebar section#options a.saveChanges").unbind(),$("section.sidebar section#options a.saveChanges").data("id"),$("section.sidebar section#options a.saveChanges").click(function(){var e=1==$("input.priority#low").prop("checked")?-1:1==$("input.priority#normal").prop("checked")?0:1;TransmissionServer.sendServerRequest({method:"torrent-set",arguments:{ids:$(this).data("id"),bandwidthPriority:e,downloadDir:$("section#options table input.downloadDirectory").val(),downloadLimited:$("section#options table .downloadSpeedToggle input").prop("checked"),downloadLimit:$("section#options table input.downloadSpeed").val(),uploadLimited:$("section#options table .uploadSpeedToggle input").prop("checked"),uploadLimit:$("section#options table input.uploadSpeed").val(),seedRatioLimit:$("section#options table input.stopSeedingAt").val(),maxConnectedPeers:$("section#options table input.maxConnections").val()}},function(e){$("#Materialize.toast-container").css("z-index",100001),Materialize.toast(i18n.status.success,500,"rounded"),setTimeout(function(){$("#Materialize.toast-container").css("z-index",1e4)},550)}),$("section#options table .downloadSpeedToggle input").prop("checked"),$("section#options table .uploadSpeedToggle input").prop("checked"),$("section#options table input.downloadDirectory").val(),$("section#options table input.priority").val(),$("section#options table input.stopSeedingAt").val(),$("section#options table input.downloadSpeed").val(),$("section#options table input.uploadSpeed").val(),$("section#options table input.maxConnections").val()})},changeTorrentProperties:function(e,t,n,r,o,s){0!==n.error?(1==n.error?s.text(i18n.event.trackerWarning):2==n.error?s.text(i18n.event.trackerError):s.text(i18n.event.error),s.text(i18n.event.error+": "+n.errorString+" [#"+n.error+"]"),r.removeClass("default paused queued downloading seeding idling errored").addClass("errored")):0===t?(s.text(Formatter.event(t)),r.removeClass("default paused queued downloading seeding idling errored").addClass("paused")):1==t||2==t||3==t?(s.text(Formatter.event(t)),r.removeClass("default paused queued downloading seeding idling errored").addClass("queued")):4==t?(s.text(Formatter.event(t)+": "+Formatter.speed(n.rateDownload)+", "+Formatter.event(6)+": "+Formatter.speed(n.rateUpload)),r.removeClass("default paused queued downloading seeding idling errored").addClass("downloading")):5==t?(s.text(Formatter.event(t)),r.removeClass("default paused queued downloading seeding idling errored").addClass("queued")):6==t||8==t?(s.text(Formatter.event(t)+": "+Formatter.speed(n.rateUpload)),r.removeClass("default paused queued downloading seeding idling errored").addClass("seeding")):(s.text(Formatter.event(t)),r.removeClass("default paused queued downloading seeding idling errored").addClass("errored")),o.text(0===t?"play_arrow":"stop"),o.data("statusCode")!==t&&(o.unbind(),0==t?o.click(function(){TransmissionServer.sendServerRequest({method:"torrent-start",arguments:{ids:e}},function(e){Materialize.toast(i18n.event.started,1e3,"rounded")})}):o.click(function(){TransmissionServer.sendServerRequest({method:"torrent-stop",arguments:{ids:e}},function(e){Materialize.toast(i18n.event.stopped,1e3,"rounded")})}))},getMoreTorrentDetails:function(){$("section.torrents section.torrent a.getMoreDetails").unbind(),$("section.torrents section.torrent:not(.hidden) a.getMoreDetails, section.torrents.searchQuery section.torrent.result a.getMoreDetails").click(function(){TransmissionServer._waitLock=!0;var e=$(this).parent().parent().data("id"),t=$(this).parent().parent();$("section.parachute").css("top",$("body").scrollTop()),$("section.parachute").fadeIn(300,function(){t.addClass("hidden"),t.children("section.card-action").fadeOut(),t.addClass("stacked"),t.removeClass("hidden"),t.css("top",$("body").scrollTop()+$("body").height()),t.animate({top:$("body").scrollTop()},300),TorrentSidebar.initialize(e,t),Sidebar.open("torrentInformation")})})},getTorrents:function(){var e={method:"torrent-get",arguments:{fields:["id","name","status","totalSize","sizeWhenDone","leftUntilDone","eta","downloadedEver","uploadedEver","uploadRatio","rateDownload","rateUpload","trackerStats","error","errorString","bandwidthPriority"]}},t=!1;Listener.lastRefresh=Date.now(),TransmissionServer.sendServerRequest(e,function(e){TransmissionServer._waitLock=!0,torrents=e.arguments.torrents,""==$("section.torrentPagination a.pageInfo span.currentPage").text()&&$("section.torrentPagination a.pageInfo span.currentPage").text("1");var n=Math.floor(torrents.length/Configuration.torrentsPerPage);torrents.length%Configuration.torrentsPerPage>0&&n++,$("section.torrentPagination a.pageInfo span.totalPages").text(n),$.each(torrents,function(e,n){n.totalEver=Formatter.size(n.downloadedEver+n.uploadedEver),n.downloadedEver=Formatter.size(n.downloadedEver),n.uploadedEver=Formatter.size(n.uploadedEver),n.percentageDone=Formatter.percentageDone(n.leftUntilDone,n.totalSize),n.uploadRatio=Math.round(100*n.uploadRatio)/100,torrentElement=$('section.torrents section.torrent[data-id="'+n.id+'"]'),torrentSwitchElement=$('section.torrents section.torrent[data-id="'+n.id+'"] i.material-icons.toggle'),torrentMessageElement=$('section.torrents section.torrent[data-id="'+n.id+'"] p.message'),Listener.changeTorrentProperties(n.id,n.status,n,torrentElement,torrentSwitchElement,torrentMessageElement),$('section.torrents section.torrent[data-id="'+n.id+'"]').length?($('section.torrents section.torrent[data-id="'+n.id+'"] h3.torentName span.name').text(n.torrentName),$('section.torrents section.torrent[data-id="'+n.id+'"] span.downloaded').text(n.downloadedEver),$('section.torrents section.torrent[data-id="'+n.id+'"] span.uploaded').text(n.uploadedEver),$('section.torrents section.torrent[data-id="'+n.id+'"] span.total').text(n.totalEver),$('section.torrents section.torrent[data-id="'+n.id+'"] span.uploadRatio').text(n.uploadRatio),$('section.torrents section.torrent[data-id="'+n.id+'"] .determinate').css("width")!=n.percentageDone&&$('section.torrents section.torrent[data-id="'+n.id+'"] .determinate').css({width:n.percentageDone}),$('section.torrents section.torrent[data-id="'+n.id+'"]').data("href",Listener.lastRefresh)):($("section.elements section.torrent.unset").clone().appendTo("section.torrents"),$("section.torrents section.torrent.unset").attr("data-id",n.id),$("section.torrents section.torrent.unset").attr("data-href",Listener.lastRefresh),$("section.torrents section.torrent.unset span.name").text(n.name),$("section.torrents section.torrent.unset span.downloaded").text(n.downloadedEver),$("section.torrents section.torrent.unset span.uploaded").text(n.uploadedEver),$("section.torrents section.torrent.unset span.total").text(n.totalEver),$("section.torrents section.torrent.unset span.uploadRatio").text(n.uploadRatio),$("section.torrents section.torrent.unset section.progress section.intermediate").css("width",n.percentageDone),$("section.torrents section.torrent.unset").removeClass("unset")),0!==n.error&&(t=!0)}),$("section.torrents section.torrent").each(function(e,t){$(this).data("href")!=Listener.lastRefresh&&$(this).fadeOut()}),t?$('section.header ul li[data-href="errored"]').css("visibility","visible"):$('section.header ul li[data-href="errored"]').css("visibility","hidden"),Listener.batchOperations(),Listener.getMoreTorrentDetails(),Listener.selectTorrent(),Listener.torrentPagination(),TransmissionServer._waitLock=!1})},removeTorrent:function(e){$("section.sidebar section.removeTorrent span.torrentString").text(e.length),1!=e.length?$("section.sidebar section.removeTorrent span.plural").removeClass("hidden"):$("section.sidebar section.removeTorrent span.plural").addClass("hidden"),0==e.length&&(e=[]),$("section.sidebar section.removeTorrent a.removeTorrent").unbind(),$("section.sidebar section.removeTorrent a.removeTorrent").click(function(){TransmissionServer.sendServerRequest({method:"torrent-remove",arguments:{ids:e,"delete-local-data":$("section.sidebar section.removeTorrent input#deleteAllData").prop("checked")}},function(e){Materialize.toast(i18n.status.success,500,"rounded")})}),Sidebar.open("removeTorrent")},searchTorrent:function(){$("section.torrentSearch input.search").unbind(),$("section.torrentSearch input.search").keyup(function(){var e=$(this).val().toLowerCase(),t=!0;0==e.length?($("section.torrents").removeClass("searchQuery").addClass(activeTab),$("section.torrentPagination").slideDown(75),$("section.torrents section.torrent").removeClass("result suffix-2 tablet-suffix-5 prefix-2 tablet-prefix-5"),$("section.torrentSearch").animate({padding:"0 40px 15px"},75),$("section.torrentPagination").slideDown(75)):($("section.torrentSearch").animate({padding:"15px 40px"},75),$("section.torrentPagination").slideUp(75),$("section.torrents section.torrent").each(function(n,r){var o=$(this).find("section.card-content h3.torrentName span.name").text().toLowerCase();o.indexOf(e)!=-1||""==o?($("section.torrents").removeClass("all downloading seeding idling paused errored").addClass("searchQuery"),$(this).removeClass("result suffix-2 tablet-suffix-5 prefix-2 tablet-prefix-5").addClass("result "+(t?"suffix-2 tablet-suffix-5":"prefix-2 tablet-prefix-5")),t=!t):$(this).removeClass("suffix-2 tablet-suffix-5 prefix-2 tablet-prefix-5").removeClass("result")})),Listener.getMoreTorrentDetails()})},searchTracker:function(){$("section#trackers section.trackerSearch input.search").unbind(),$("section#trackers section.trackerSearch input.search").keyup(function(){var e=$(this).val().toLowerCase();0==e.length?$("section.trackers").removeClass("searchQuery"):$("section#trackers section.tracker").each(function(t,n){var r=$(this).data("host").toLowerCase();$("section.trackers").addClass("searchQuery"),r.indexOf(e)!=-1||""==r?$(this).addClass("result"):$(this).removeClass("result")})})},selectTorrent:function(){$("section.torrents section.torrent a.selectTorrent").unbind(),$("section.torrents section.torrent:not(.hidden) a.selectTorrent, section.torrents.searchQuery section.torrent.result a.selectTorrent").click(function(){var e=$(this).parent().parent();e.toggleClass("selected")})},toggleTorrentPage:function(e){if(0==$("section.torrentSearch input.search").val().length){$("section.torrents section.torrent").addClass("hidden");var t=($("section.torrents section.torrent").length,(e-1)*Configuration.torrentsPerPage),n=e*Configuration.torrentsPerPage-1;$("section.torrents section.torrent").each(function(e,r){e>=t&&e<=n?$(this).removeClass("hidden"):$(this).addClass("hidden")}),$("section.torrentPagination a.pageInfo span.currentPage").text(e)}},torrentPagination:function(){$("section.torrentPagination button.previousPage, section.torrentPagination button.nextPage").unbind(),Listener.toggleTorrentPage($("section.torrentPagination a.pageInfo span.currentPage").text());var e=parseInt($("section.torrentPagination a.pageInfo span.currentPage").text()),t=parseInt($("section.torrentPagination a.pageInfo span.totalPages").text());e>t&&(Listener.toggleTorrentPage(t),$("section.torrentPagination a.pageInfo span.currentPage").text(t)),$("section.torrentPagination button.previousPage").click(function(){var e=parseInt($("section.torrentPagination a.pageInfo span.currentPage").text())-1;e>0&&Listener.toggleTorrentPage(e)}),$("section.torrentPagination button.nextPage").click(function(){var e=parseInt($("section.torrentPagination a.pageInfo span.currentPage").text())+1;e<=parseInt($("section.torrentPagination a.pageInfo span.totalPages").text())&&Listener.toggleTorrentPage(e)}),$("section.modal#viewOptions").modal({dismissible:!1,ready:function(){$("section.modal#viewOptions select").material_select(),$("section.modal#viewOptions select.page").material_select("destroy"),$("section.modal#viewOptions select.page").html("");for(var e=1;e<=parseInt($("section.torrentPagination a.pageInfo span.totalPages").text());e++)e==parseInt($("section.torrentPagination a.pageInfo span.currentPage").text())?$("section.modal#viewOptions select.page").append('<option value="'+e+'" selected>'+i18n.htmlStrings.pagination.page+" "+e+" "+i18n.htmlStrings.viewOptions.current+"</option>"):$("section.modal#viewOptions select.page").append('<option value="'+e+'">'+i18n.htmlStrings.pagination.page+" "+e+"</option>");$("section.modal#viewOptions select.page").material_select(),$("section.modal#viewOptions select.torrentsPerPage").material_select("destroy"),$('section.modal#viewOptions select.torrentsPerPage option[value="'+Configuration.torrentsPerPage+'"]').attr("selected","selected"),$("section.modal#viewOptions select.torrentsPerPage").material_select(),$('section.modal#viewOptions input[name="view"][value="'+Configuration.torrentView+'"]').attr("checked","checked"),Internationalization.setSupportedLanguages()},complete:function(){Configuration.torrentsPerPage=session.set("torrentsPerPage",parseInt($("section.modal#viewOptions select.torrentsPerPage").val())),Configuration.torrentView=session.set("torrentView",$('section.modal#viewOptions input[name="view"]:checked').val()),Configuration.language=session.set("language",$("section.modal#viewOptions select.language").val()),$("section.torrents").attr("view",Configuration.torrentView),Internationalization.changeLanguage(Configuration.language),Listener.toggleTorrentPage(parseInt($("section.modal#viewOptions select.page").val())),Listener.getTorrents()}})},setIntervals:function(){Listener.updateStatistics(),Listener.getTorrents(),setTimeout(function(){Listener.setIntervals()},Configuration.torrentRefreshInterval)},showCredits:function(){$("section.floatingOptions ul li a.credits").unbind(),$("section.floatingOptions ul li a.credits").click(function(){Sidebar.open("credits")})}};
var TransmissionServer={_token:"",_latestTorrentRefresh:0,_currentPage:1,_waitLock:!1,_downloadFolder:"",sendServerRequest:function(e,r){"boolean"!=typeof async&&(async=!0);var s={url:"../rpc",type:"POST",contentType:"json",dataType:"json",cache:!1,data:JSON.stringify(e),beforeSend:function(e){TransmissionServer._token&&e.setRequestHeader("X-Transmission-Session-Id",TransmissionServer._token)},error:function(e,r,n){TransmissionServer.ajaxErrorHandler(e,r,n,s)},success:r,async:!0};TransmissionServer._waitLock?setTimeout(function(){TransmissionServer.sendServerRequest(e,r)},250):$.ajax(s)},ajaxErrorHandler:function(e,r,s,n){var o;return 409===e.status||(o=e.getResponseHeader("X-Transmission-Session-Id"))?(TransmissionServer._token=e.getResponseHeader("X-Transmission-Session-Id"),void $.ajax(n)):(TransmissionServer._error=e.responseText?e.responseText.trim().replace(/(<([^>]+)>)/gi,""):"",TransmissionServer._error.length||(TransmissionServer._error=i18n.server.notResponding),void Materialize.toast(TransmissionServer._error,2500,"rounded"))},getSettings:function(){var e={method:"session-get"};TransmissionServer.sendServerRequest(e,function(e){Formatter.units=e.arguments.units,e.arguments["alt-speed-enabled"]?($("a.speedLimitMode").removeClass("green"),$("a.speedLimitMode").addClass("red")):($("a.speedLimitMode").removeClass("red"),$("a.speedLimitMode").addClass("green"))})}};
var TorrentSidebar={interval:"",torrentElement:"",settingsInitalized:!1,initialize:function(t,e){TorrentSidebar.torrentElement=e,setTimeout(function(){$('ul.tabs.tabs-fixed-width li.tab a[href="#information"]').trigger("click")},300),$("section.sidebar section.torrentInformation").animate({right:"0%"},300),$("section.torrent i.closeSidebar").removeClass("hidden"),$("section.torrent i.closeSidebar, section.sidebar section.torrentInformation h3 span.showOnMobile i.closeSidebar").unbind(),$("section.torrent i.closeSidebar, section.sidebar section.torrentInformation h3 span.showOnMobile i.closeSidebar").click(function(){$("section.sidebar section.torrentInformation").animate({right:"-100%"},300),$("body").css("overflow","initial"),e.animate({top:$("body").scrollTop()+$("body").height()},300,function(){$(this).css("top","initial")}),setTimeout(function(){TransmissionServer._waitLock=!0,e.children("section.card-action").fadeIn(),e.removeClass("stacked"),e.removeClass("hidden"),e.css("top","initial"),$("section.parachute").fadeOut(300),$("section.torrent i.closeSidebar").addClass("hidden"),$("section.torrent i.closeSidebar, section.sidebar section.torrentInformation h3 span.showOnMobile i.closeSidebar").unbind(),clearInterval(TorrentSidebar.interval),TransmissionServer._waitLock=!1},300),Sidebar.close()}),$("section.sidebar section.torrentInformation section#trackers section.tracker").remove(),$("section.sidebar section.torrentInformation section#peers tr.peer").remove(),$("section.sidebar section.torrentInformation section#files section.file").remove(),TorrentSidebar.refresh(t),TorrentSidebar.interval=setInterval(function(){TorrentSidebar.refresh(t)},1e3),TransmissionServer._waitLock=!1},refresh:function(t){TransmissionServer.sendServerRequest({method:"torrent-get",arguments:{ids:t,fields:["id","name","status","totalSize","sizeWhenDone","haveValid","leftUntilDone","haveUnchecked","eta","uploadedEver","uploadRatio","rateDownload","rateUpload","metadataPercentComplete","addedDate","trackerStats","error","errorString","recheckProgress","bandwidthPriority","seedRatioMode","seedRatioLimit","downloadDir","creator","hashString","comment","isPrivate","downloadedEver","peersGettingFromUs","peersSendingToUs","files","pieceCount","pieceSize","peers","fileStats","peer-limit","downloadLimited","uploadLimit","uploadLimited","downloadLimit","corruptEver","maxConnectedPeers"]}},function(t){torrent=t.arguments.torrents[0],$("section.sidebar section.torrentInformation h3 span.torrentName").text(torrent.name),$("section.sidebar section.torrentInformation section#information table td.size").text(Formatter.size(torrent.sizeWhenDone)),$("section.sidebar section.torrentInformation section#information table td.pieces").text(torrent.pieceCount+" * "+Formatter.size(torrent.pieceSize)),$("section.sidebar section.torrentInformation section#information table td.hash").text(torrent.hashString),$("section.sidebar section.torrentInformation section#information table td.type").text(torrent.isPrivate?i18n.htmlStrings.sidebarView.tabs.information.type.privateTorrent:i18n.htmlStrings.sidebarView.tabs.information.type.publictorrent),$("section.sidebar section.torrentInformation section#information table td.comment").text(torrent.comment),$("section.sidebar section.torrentInformation section#information table td.createdWith").text(torrent.creator),$("section.sidebar section.torrentInformation section#activity table td.status").text(Formatter.event(torrent.status)),$("section.sidebar section.torrentInformation section#activity table td.torrentProgress").text(Formatter.percentageDone(torrent.leftUntilDone,torrent.totalSize)),$("section.sidebar section.torrentInformation section#activity table td.downloaded").text(Formatter.size(torrent.downloadedEver)),$("section.sidebar section.torrentInformation section#activity table td.uploaded").text(Formatter.size(torrent.uploadedEver)),$("section.sidebar section.torrentInformation section#activity table td.ratio").text(torrent.uploadRatio),$("section.sidebar section.torrentInformation section#activity table span.downloadSpeed").text(Formatter.speed(torrent.rateDownload)),$("section.sidebar section.torrentInformation section#activity table span.downloadPeers").text(torrent.peersSendingToUs),$("section.sidebar section.torrentInformation section#activity table span.uploadSpeed").text(Formatter.speed(torrent.rateUpload)),$("section.sidebar section.torrentInformation section#activity table span.uploadPeers").text(torrent.peersGettingFromUs),$.each(torrent.trackerStats,function(t,e){var o='section.sidebar section.torrentInformation section#trackers section.trackers section.tracker[data-host="'+e.host+'"]';$(o).length||($("section.elements section.tracker.unset").clone().appendTo("section.sidebar section.torrentInformation section#trackers section.trackers"),$("section.sidebar section.torrentInformation section#trackers section.trackers section.tracker.unset").attr("data-host",e.host).removeClass("unset")),$(o+" h4.host").text(e.host),$(o+" td.lastAnnounced").text(Formatter.date(e.lastAnnounceTime)),$(o+" td.nextAnnounced").text(Formatter.date(e.nextAnnounceTime)),$(o+" td.lastScrape").text(Formatter.date(e.lastScrapeTime)),$(o+" td.seeders").text(e.seederCount),$(o+" td.leechers").text(e.leecherCount)}),$("section.sidebar section.torrentInformation section#peers tr.peer").remove(),$.each(torrent.peers,function(t,e){var o='section.sidebar section.torrentInformation section#peers table tr[data-host="'+e.address+":"+e.port+'"]';$(o).length||($("section.elements tr.peer.unset").clone().appendTo("section.sidebar section.torrentInformation section#peers table"),$("section.sidebar section.torrentInformation section#peers table tr.unset").attr("data-host",e.address+":"+e.port).removeClass("unset")),$(o+" td:nth-child(1)").text(e.address+":"+e.port),$(o+" td:nth-child(2)").text(e.clientName),$(o+" td:nth-child(3)").text(100*e.progress),$(o+" td:nth-child(4)").text(Formatter.speed(e.rateToClient)),$(o+" td:nth-child(5)").text(Formatter.speed(e.rateToPeer))}),$.each(torrent.files,function(t,e){var o='section.sidebar section.torrentInformation section#files section.file[data-id="'+e+'"]';$(o).length||($("section.elements section.file.unset").clone().appendTo("section.sidebar section.torrentInformation section#files"),$("section.sidebar section.torrentInformation section#files section.file.unset").attr("data-id",e),$(o+' span.download input[type="checkbox"]').attr("id","downloadfile"+t).attr("data-torrentid",torrent.id).attr("data-fileid",t),$(o+" span.download label").attr("for","downloadfile"+t),$(o+" h4 span:nth-child(1)").text(e.name),torrent.fileStats[t].wanted&&$(o+' span.download input[type="checkbox"]').attr("checked","checked"),$(o).removeClass("unset")),$(o+" td.completed").text(Formatter.percentageDone(e.length-e.bytesCompleted,e.length)+i18n.htmlStrings.sidebarView.tabs.files.of+Formatter.size(e.length))}),Listener.changeDownloadedFiles(),0==TorrentSidebar.settingsInitalized&&($("section#options table .downloadSpeedToggle input").prop("checked",torrent.downloadLimited),$("section#options table .uploadSpeedToggle input").prop("checked",torrent.uploadLimited),torrent.bandwidthPriority==-1?$("input.priority#low").prop("checked",!0):0==torrent.bandwidthPriority?$("input.priority#normal").prop("checked",!0):$("input.priority#high").prop("checked",!0),$("section#options table input.downloadDirectory").val(torrent.downloadDir),$("section#options table input.priority").val(torrent.bandwidthPriority),$("section#options table input.stopSeedingAt").val(torrent.seedRatioLimit),$("section#options table input.downloadSpeed").val(torrent.downloadLimit),$("section#options table input.uploadSpeed").val(torrent.uploadLimit),$("section#options table input.maxConnections").val(torrent.maxConnectedPeers),TorrentSidebar.settingsInitalized=!0),Listener.changeSettingsTorrent(torrent.id)})}};
var i18n,Internationalizations={setSupportedLanguages:function(){$("section.modal#viewOptions select.language").html(""),$.each(LanguageCodes,function(index,key){"undefined"!==eval("typeof "+index)&&(Configuration.language==index?$("section.elements option.language.unset").clone().val(index).text(key+" "+i18n.htmlStrings.viewOptions.current).attr("selected","selected").appendTo("section.modal#viewOptions select.language"):$("section.elements option.language.unset").clone().val(index).text(key).appendTo("section.modal#viewOptions select.language"))}),$("section.modal#viewOptions select.language").material_select()},changeLanguage:function(language,callback,shutup){"undefined"==typeof shutup&&(shutup=!1),"undefined"!==eval("typeof "+language)?(i18n=eval(language),shutup||Materialize.toast(i18n.internationalization.changingLanguagePack+LanguageCodes[language]+i18n.internationalization.changingLanguagePackAfter,1e3,"rounded"),$("*[i18n-text]").each(function(index,target){text=eval($(this).attr("i18n-text")),textBefore=$(this).attr("i18n-text-before")?$(this).attr("i18n-text-before"):"",textAfter=$(this).attr("i18n-text-after")?$(this).attr("i18n-text-after"):"",$(target).text(textBefore+text+textAfter)}),$("*[i18n-tooltip]").each(function(index,target){text=eval($(this).attr("i18n-tooltip")),textBefore=$(this).attr("i18n-tooltip-before")?$(this).attr("i18n-tooltip-before"):"",textAfter=$(this).attr("i18n-tooltip-after")?$(this).attr("i18n-tooltip-after"):"",$(target).attr("data-tooltip",textBefore+text+textAfter)}),shutup||Materialize.toast(i18n.internationalization.changedLanguagePack,1e3,"rounded")):(shutup||Materialize.toast(i18n.internationalization.languagePackNotAvailable,1e3,"rounded"),setTimeout(function(){Materialize.toast(i18n.internationalization.attemptingLanguagePack+LanguageCodes[Configuration.language],1e3,"rounded"),Internationalization.changeLanguage(Configuration.language)},500)),"function"==typeof callback&&callback()}};
var LanguageCodes={aa:"Afar",ab:"Abkhazian",ae:"Avestan",af:"Afrikaans",ak:"Akan",am:"Amharic",an:"Aragonese",ar:"Arabic",as:"Assamese",av:"Avaric",ay:"Aymara",az:"Azerbaijani",ba:"Bashkir",be:"Belarusian",bg:"Bulgarian",bh:"Bihari languages",bi:"Bislama",bm:"Bambara",bn:"Bengali",bo:"Tibetan",br:"Breton",bs:"Bosnian",ca:"Catalan; Valencian",ce:"Chechen",ch:"Chamorro",co:"Corsican",cr:"Cree",cs:"Czech",cu:"Church Slavic; Old Slavonic; Church Slavonic; Old Bulgarian; Old Church Slavonic",cv:"Chuvash",cy:"Welsh",da:"Danish",de:"German",dv:"Divehi; Dhivehi; Maldivian",dz:"Dzongkha",ee:"Ewe",el:"Greek, Modern (1453-)",en:"English",eo:"Esperanto",es:"Spanish; Castilian",et:"Estonian",eu:"Basque",fa:"Persian",ff:"Fulah",fi:"Finnish",fj:"Fijian",fo:"Faroese",fr:"French",fy:"Western Frisian",ga:"Irish",gd:"Gaelic; Scottish Gaelic",gl:"Galician",gn:"Guarani",gu:"Gujarati",gv:"Manx",ha:"Hausa",he:"Hebrew",hi:"Hindi",ho:"Hiri Motu",hr:"Croatian",ht:"Haitian; Haitian Creole",hu:"Hungarian",hy:"Armenian",hz:"Herero",ia:"Interlingua (International Auxiliary Language Association)",id:"Indonesian",ie:"Interlingue; Occidental",ig:"Igbo",ii:"Sichuan Yi; Nuosu",ik:"Inupiaq",io:"Ido",is:"Icelandic",it:"Italian",iu:"Inuktitut",ja:"Japanese",jv:"Javanese",ka:"Georgian",kg:"Kongo",ki:"Kikuyu; Gikuyu",kj:"Kuanyama; Kwanyama",kk:"Kazakh",kl:"Kalaallisut; Greenlandic",km:"Central Khmer",kn:"Kannada",ko:"Korean",kr:"Kanuri",ks:"Kashmiri",ku:"Kurdish",kv:"Komi",kw:"Cornish",ky:"Kirghiz; Kyrgyz",la:"Latin",lb:"Luxembourgish; Letzeburgesch",lg:"Ganda",li:"Limburgan; Limburger; Limburgish",ln:"Lingala",lo:"Lao",lt:"Lithuanian",lu:"Luba-Katanga",lv:"Latvian",mg:"Malagasy",mh:"Marshallese",mi:"Maori",mk:"Macedonian",ml:"Malayalam",mn:"Mongolian",mr:"Marathi",ms:"Malay",mt:"Maltese",my:"Burmese",na:"Nauru",nb:"Bokmål, Norwegian; Norwegian Bokmål",nd:"Ndebele, North; North Ndebele",ne:"Nepali",ng:"Ndonga",nl:"Dutch; Flemish",nn:"Norwegian Nynorsk; Nynorsk, Norwegian",no:"Norwegian",nr:"Ndebele, South; South Ndebele",nv:"Navajo; Navaho",ny:"Chichewa; Chewa; Nyanja",oc:"Occitan (post 1500); Provençal",oj:"Ojibwa",om:"Oromo",or:"Oriya",os:"Ossetian; Ossetic",pa:"Panjabi; Punjabi",pi:"Pali",pl:"Polish",ps:"Pushto; Pashto",pt:"Portuguese",qu:"Quechua",rm:"Romansh",rn:"Rundi",ro:"Romanian; Moldavian; Moldovan",ru:"Russian",rw:"Kinyarwanda",sa:"Sanskrit",sc:"Sardinian",sd:"Sindhi",se:"Northern Sami",sg:"Sango",si:"Sinhala; Sinhalese",sk:"Slovak",sl:"Slovenian",sm:"Samoan",sn:"Shona",so:"Somali",sq:"Albanian",sr:"Serbian",ss:"Swati",st:"Sotho, Southern",su:"Sundanese",sv:"Swedish",sw:"Swahili",ta:"Tamil",te:"Telugu",tg:"Tajik",th:"Thai",ti:"Tigrinya",tk:"Turkmen",tl:"Tagalog",tn:"Tswana",to:"Tonga (Tonga Islands)",tr:"Turkish",ts:"Tsonga",tt:"Tatar",tw:"Twi",ty:"Tahitian",ug:"Uighur; Uyghur",uk:"Ukrainian",ur:"Urdu",uz:"Uzbek",ve:"Venda",vi:"Vietnamese",vo:"Volapük",wa:"Walloon",wo:"Wolof",xh:"Xhosa",yi:"Yiddish",yo:"Yoruba",za:"Zhuang; Chuang",zh:"Chinese",zu:"Zulu"};
var en={internationalization:{changingLanguagePack:"Changing language pack to ",changingLanguagePackAfter:"...",changedLanguagePack:"Changed language pack successfully.",languagePackNotAvailable:"The selected language pack is not available!",attemptingLanguagePack:"Attempting to change language pack to ",attemptingLanguagePackAfter:" (system default)"},units:{speed_B_str:"B/s",speed_K_str:"kB/s",speed_M_str:"MB/s",speed_G_str:"GB/s",speed_T_str:"TB/s",size_B_str:"B",size_K_str:"KB",size_M_str:"MB",size_G_str:"GB",size_T_str:"TB",mem_B_str:"B",mem_K_str:"KiB",mem_M_str:"MiB",mem_G_str:"GiB",mem_T_str:"TiB"},filePriority:{low:"Low",normal:"Normal",high:"High"},event:{paused:"Paused",queuedForVerification:"Queued for verification",verifyingLocalData:"Verifying local data",queued:"Queued",downloading:"Downloading",downloadedQueuedForSeeding:"Downloaded, queued for seeding",seeding:"Seeding",error:"Error",unknown:"Unknown"},server:{notResponding:"Server not responding, retrying in 2.5 seconds..."},status:{on:"On",off:"Off",success:"Success!",failure:"Failure",errorAddingTorrent:"Error adding torrent: ",torrentAdded:"Torrent added!",trackerWarning:"Tracker warning: ",trackerError:"Tracker error: ",error:"Error: "},misc:{thisSession:"this session"},htmlStrings:{title:"Transmission Web Interface",topBar:{statistics:"STATISTICS",bandwidth:"BANDWIDTH",date:"DATE"},filterOptions:{text:"Filter torrents by...",all:"All",downloading:"Downloading",seeding:"Seeding",idling:"Idling",queued:"Queued",paused:"Paused",errored:"Errored"},tooltips:{start:"Start",stop:"Stop",verifyLocalData:"Verify Local Data",askTrackerForMorePeers:"Ask tracker for more peers","delete":"Delete",addTorrent:"Add Torrent",credits:"Credits",toggleSpeedLimitMode:"Toggle Speed Limit Mode",settings:"Settings"},pagination:{page:"Page",of:"of",previousPage:"Prev Page",nextPage:"Next Page"},searchTorrent:"Search Torrent...",torrent:{event:{started:"Torrent started.",stopped:"Torrent stopped."}},sidebarView:{tabs:{information:{title:"Information",torrentInformation:"Torrent Information",size:"Size",pieces:"Pieces",hash:"Hash",type:{title:"Type",privateTorrent:"Private Torrent",publicTorrent:"Public Torrent"},comment:"Comment",createdWith:"Created with"},activity:{title:"Activity",status:"Status",progress:"Progress",downloaded:"Downloaded",uploaded:"Uploaded",ratio:"Ratio",downloadSpeed:"Download Speed",uploadSpeed:"Upload Speed",from:"from",peers:"peers"},trackers:{title:"Trackers",searchTracker:"Search tracker",tracker:{lastAnnounced:"Last Announced",nextAnnounced:"Next Announced",lastScrape:"Last Scrape",seeders:"Seeders",leechers:"Leechers"}},peers:{title:"Peers",ipAddress:"IP Address",client:"Client",percentageDone:"%",uploading:"Uploading",downloading:"Downloading"},files:{title:"Files",of:" of "},options:{title:"Options",downloadDirectory:"Download Directory",priority:"Priority",low:"Low",normal:"Normal",high:"High",stopSeedingAt:"Stop Seeding At",limitDownloadSpeed:"Limit Download Speed",limitUploadSpeed:"Limit Upload Speed",maximumConnections:"Maximum Connections",saveChanges:"Save Changes"}},settings:{title:"Settings",saveSettings:"Save Settings"},statistics:{title:"Statistics",activeTorrents:"Active Torrents",pausedTorrents:"Paused Torrents",totalDownloaded:"Total Downloaded",totalUploaded:"Total Uploaded",ratio:"Ratio",uptime:"Uptime"},addTorrent:{title:"Add Torrent",file:"File",selectPlaceholder:"Select one or more .torrent files",urlLabel:"Torrent URL or magnet: Link",destinationDirectory:"Destination Directory",startAutomatically:"Start Automatically"},removeTorrent:{title:"Remove Torrent",validationMessage:"Are you sure that you would like to remove",torrent:"torrent",torrentPlural:"s",deleteAllData:"Delete All Data"},credits:{title:"Credits",specialThanks:"Special Thanks"}},sidebarOverflow:{clickToClose:"Click to close"},viewOptions:{"default":"default",all:"All",torrentsPerPage:"Torrents Per Page",language:"Language",current:"(current)"}}};