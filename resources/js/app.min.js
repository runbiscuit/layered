...
var Formatter={units:"",speed_K:1e3,speed_B_str:"B/s",speed_K_str:"kB/s",speed_M_str:"MB/s",speed_G_str:"GB/s",speed_T_str:"TB/s",size_K:1e3,size_B_str:"B",size_K_str:"KB",size_M_str:"MB",size_G_str:"GB",size_T_str:"TB",mem_K:1024,mem_B_str:"B",mem_K_str:"KiB",mem_M_str:"MiB",mem_G_str:"GiB",mem_T_str:"TiB",duration:function(e){return new Date(1e3*e).toTimeString().replace(/.*(\d{2}:\d{2}:\d{2}).*/,"$1")},date:function(e){return new Date(1e3*e)},filePriority:function(e){return e==-1?"Low":0==e?"Normal":1==e?"High":void 0},percentageDone:function(e,t){return Math.round((t-e)/t*1e4)/100+"%"},mem:function(e){if(e<Formatter.mem_K)return[e,Formatter.mem_B_str].join(" ");var t,r;return e<Math.pow(Formatter.mem_K,2)?(t=e/Formatter.mem_K,r=Formatter.mem_K_str):e<Math.pow(Formatter.mem_K,3)?(t=e/Math.pow(Formatter.mem_K,2),r=Formatter.mem_M_str):e<Math.pow(mem_K,4)?(t=e/Math.pow(Formatter.mem_K,3),r=Formatter.mem_G_str):(t=e/Math.pow(Formatter.mem_K,4),r=Formatter.mem_T_str),t=Math.round(100*t)/100,t+r},ratio:function(e,t){return 0==e?0:Math.floor(t/e*1e3)/1e3},size:function(e){if(e<Formatter.size_K)return[e,Formatter.size_B_str].join(" ");var t,r;return e<Math.pow(Formatter.size_K,2)?(t=e/Formatter.size_K,r=Formatter.size_K_str):e<Math.pow(Formatter.size_K,3)?(t=e/Math.pow(Formatter.size_K,2),r=Formatter.size_M_str):e<Math.pow(Formatter.size_K,4)?(t=e/Math.pow(Formatter.size_K,3),r=Formatter.size_G_str):(t=e/Math.pow(Formatter.size_K,4),r=Formatter.size_T_str),t=Math.round(100*t)/100,t+r},speed:function(e){if(e<Formatter.speed_K)return[e,Formatter.speed_B_str].join(" ");var t,r;return e<Math.pow(Formatter.speed_K,2)?(t=e/Formatter.speed_K,r=Formatter.speed_K_str):e<Math.pow(Formatter.speed_K,3)?(t=e/Math.pow(Formatter.speed_K,2),r=Formatter.speed_M_str):e<Math.pow(speed_K,4)?(t=e/Math.pow(Formatter.speed_K,3),r=Formatter.speed_G_str):(t=e/Math.pow(Formatter.speed_K,4),r=Formatter.speed_T_str),t=Math.round(100*t)/100,t+r},event:function(e){switch(e){case 0:return"Paused";case 1:return"Queued for verification";case 2:return"Verifying local data";case 3:return"Queued";case 4:return"Downloaded";case 5:return"Downloaded, queued for seeding";case 6:return"Seeding";case 8:return"Seeding";default:return"Unknown"}}};
